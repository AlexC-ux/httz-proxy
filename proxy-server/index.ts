...
const proxy = createProxyMiddleware({
  ...
  changeOrigin: true,
  on: {
    proxyRes: responseInterceptor(async (responseBuffer, proxyRes, req, res: Response<any, ResponseLocals>) => {
      try {
...
app.use(async (req, res: Response<any, ResponseLocals>, next: (err?: any) => void) => {
